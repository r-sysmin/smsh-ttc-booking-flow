...
export const schedulingTestimonials: Testimonial[] = [
  {
    name: "Priya Raman",
    initials: "PR",
    avatar: "https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=80&h=80&fit=crop&crop=face",
    title: "Founder",
    company: "Northlark Studio",
    quote: "I stopped sending 'does Tuesday work?' emails. Clients pick a slot, it lands on my calendar, done.",
  },
  {
    name: "Diego Alvarez",
    initials: "DA",
    ...
    company: "Fieldwire",
    quote: "Our discovery-call show rate jumped from 62% to 88% after we moved to a single booking link with reminders.",
  },
  {
    name: "Hannah Okafor",
    initials: "HO",
    ...
    company: "Practice of her own",
    quote: "Availability, buffers, and timezone math used to eat an hour a day. Now it's one page my clients bookmark.",
  },
  {
    name: "Tomás Weber",
    initials: "TW",
    ...
    company: "Relay",
    quote: "Round-robin between four interviewers used to be a spreadsheet nightmare. Candidates now book themselves in 20 seconds.",
  },
  {
    name: "Mei Tanaka",
    initials: "MT",
    avatar: "https://images.unsplash.com/photo-1502378735452-bc7d86632805?w=80&h=80&fit=crop&crop=face",
    title: "Independent Consultant",
    company: "Tanaka Advisory",
    quote: "Paid strategy calls collect payment at booking. I haven't chased an invoice for a 30-minute call in a year.",
  },
  {
    name: "Owen Bradley",
    initials: "OB",
    ...
    company: "Kettle",
    quote: "Every CSM has their own booking page linked in their signature. Renewals meetings just… appear.",
  },
];
