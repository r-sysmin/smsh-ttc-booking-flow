...
import { DEFAULT_AUTHED_ROUTE, SIGNED_OUT_ROUTE } from "@/lib/auth/constants";
 ...
 * configured for the other (that is exactly why Apple was returning to /login). So we
 * establish the session from WHICHEVER arrived, then land the user INSIDE the app —
 * never `/`. Only after a genuine "no session either way" do we fall back to the auth
 * screen.
 *
