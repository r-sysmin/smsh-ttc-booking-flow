...
interface FeatureShowcaseHeaderProps {
  activeIndex: number;
...
interface FeatureShowcaseProps {
  ...
  header?: (props: FeatureShowcaseHeaderProps) => ReactNode;
}
    ...
    <section className="landing overflow-hidden bg-primary text-white">
      <div className="py-10">
        <div className="mx-auto max-w-page px-6 lg:px-8">
          {header ? header({ activeIndex, activeFeature: features[activeIndex] }) : null}
